...
export default function Projects() {
  return (
    <>
      <NextSeo
        title="Projects by Apollo | Full-stack Developer | AI/ML"
        description="Explore a collection of projects by Apollo, From innovative web applications to responsive interfaces, discover the depth and diversity of my work."
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mx-auto mt-16 max-w-5xl text-center md:mt-28">
            <span className="text-xl font-bold md:text-2xl">
              I am currently building new projects and learning AI/ML
